import p, { PureComponent as q, createRef as N, useEffect as B, forwardRef as G, useRef as J, useState as X, useImperativeHandle as V } from "react";
const _ = {
  x: 0,
  y: 0,
  width: 0,
  height: 0,
  unit: "px"
}, H = (s, t, e) => Math.min(Math.max(s, t), e), Z = (...s) => s.filter((t) => t && typeof t == "string").join(" "), P = (s, t) => s === t || s.width === t.width && s.height === t.height && s.x === t.x && s.y === t.y && s.unit === t.unit;
function ee(s, t, e, r) {
  const n = E(s, e, r);
  return s.width && (n.height = n.width / t), s.height && (n.width = n.height * t), n.y + n.height > r && (n.height = r - n.y, n.width = n.height * t), n.x + n.width > e && (n.width = e - n.x, n.height = n.width / t), s.unit === "%" ? S(n, e, r) : n;
}
function te(s, t, e) {
  const r = E(s, t, e);
  return r.x = (t - r.width) / 2, r.y = (e - r.height) / 2, s.unit === "%" ? S(r, t, e) : r;
}
function S(s, t, e) {
  return s.unit === "%" ? { ..._, ...s, unit: "%" } : {
    unit: "%",
    x: s.x ? s.x / t * 100 : 0,
    y: s.y ? s.y / e * 100 : 0,
...
function E(s, t, e) {
  return s.unit ? s.unit === "px" ? { ..._, ...s, unit: "px" } : {
    unit: "px",
    x: s.x ? s.x * t / 100 : 0,
    y: s.y ? s.y * e / 100 : 0,
    width: s.width ? s.width * t / 100 : 0,
...
const I = class M extends q {
  constructor() {
    super(...arguments), this.docMoveBound = !1, this.mouseDownOnCrop = !1, this.dragStarted = !1, this.evData = {
      ...
      this.evData = {
        ...
        clientY: t.clientY,
        isResize: !0
      }, this.mouseDownOnCrop = !0, h(E(c, l.width, l.height), S(c, l.width, l.height)), this.setState({ cropIsActive: !0, newCropIsBeingDrawn: !0 });
      ...
      if (h === "ArrowLeft" ? (o.x -= c, l = !0) : h === "ArrowRight" ? (o.x += c, l = !0) : h === "ArrowUp" ? (o.y -= c, l = !0) : h === "ArrowDown" && (o.y += c, l = !0), l) {
        t.cancelable && t.preventDefault(), o.x = H(o.x, 0, a.width - o.width), o.y = H(o.y, 0, a.height - o.height);
        const w = E(o, a.width, a.height), g = S(o, a.width, a.height);
        n(w, g), i && i(w, g);
      }
      ...
      if (!P(n, b)) {
        const u = S(b, g.width, g.height);
        c(b, u), w && w(b, u);
      }
    }, this.onDocPointerDone = (t) => {
      const { crop: e, disabled: r, onComplete: n, onDragEnd: i } = this.props, h = this.getBox();
      this.unbindDocMove(), !(r || !e) && this.mouseDownOnCrop && (this.mouseDownOnCrop = !1, this.dragStarted = !1, i && i(t), n && n(E(e, h.width, h.height), S(e, h.width, h.height)), this.setState({ cropIsActive: !1, newCropIsBeingDrawn: !1 }));
    }, this.onDragFocus = () => {
      var t;
  ...
  dragCrop() {
    ...
    return r.x = H(t.startCropX + n, 0, e.width - r.width), r.y = H(t.startCropY + i, 0, e.height - r.height), r;
  }
  ...
  resizeCrop() {
    ...
    return e || M.xyOrds.indexOf(c) > -1 ? a = y : M.xOrds.indexOf(c) > -1 ? (a.x = y.x, a.width = y.width) : M.yOrds.indexOf(c) > -1 && (a.y = y.y, a.height = y.height), a.x = H(a.x, 0, i.width - a.width), a.y = H(a.y, 0, i.height - a.height), a;
  }
  renderCropSelection() {
    const {
...
const se = G(
  (s, t) => {
    const {
      ...
      refPreviewBox: c,
      ...w
    } = s, g = J(null), [d, y] = X(), [v, b] = X(""), [u, O] = X(null), [k, A] = X(null), L = async () => e, U = async () => k || e, z = async (x = "webp") => {
      const m = g.current;
      if (!m || !u)
    ...
    return B(() => {
      ...
      /* @__PURE__ */ p.createElement(
        ...
        ) : a || /* @__PURE__ */ p.createElement("div", { className: "DefaultLoader" })
      )
    );
  }
);
